      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="col-md-6">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <button class="btn btn-outline-success mr-2 mb-2" value="submit" name="submit" type="submit" style="padding: 6px 12px; white-space: nowrap;">Submit</button>
                <button class="btn btn-outline-danger mb-2" type="reset" name="reset" style="padding: 6px 12px; white-space: nowrap;">Reset</button>
              </div>
            </div>
          </form>
        </div>
