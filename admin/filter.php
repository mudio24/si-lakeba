...
// Using HTML5 date inputs instead of jQuery UI datepicker
                ...
                <div class="row">
                    ...
                    <label for="tgl1">Dari Tanggal</label>
                        <div class="input-group mb-3">
                            ...
                            <input type="date" name="tgl1" id="datepicker1" class="form-control" placeholder="Dari Tanggal">
                        </div>
                    </div>
                    <div class="col-md-4">
                    <label for="tgl2">Ke Tanggal</label>
                        <div class="input-group mb-3">
                            ...
                            <input type="date" name="tgl2" id="datepicker2" class="form-control" placeholder="Ke Tanggal">
                        </div>
                    </div>
                </div>
                <div class="row">
                <div class="col-md-6">  
                        <button type="submit" value="searchHari" class="btn btn-outline-success mr-2" style="padding: 6px 12px; white-space: nowrap;"><span class="fas fa-search mr-2"></span>Search</button>
                        <button type="reset" class="btn btn-outline-danger" style="padding: 6px 12px; white-space: nowrap;"><span class="fas fa-times mr-2"></span>Reset</button>
                    </div>
                </div>
            </div>
          </form>
      ...
      <div class="card">
        ...
        <form action="report-bulanan.php" method="POST">
            <div class="col-md-12" id="month">
                ...
                <div class="row">
                    <div class="col-md-6">  
                        <button type="submit" value="searchBulan" class="btn btn-outline-success mr-2" style="padding: 6px 12px; white-space: nowrap;"><span class="fas fa-search mr-2"></span>Search</button>
                        <button type="reset" class="btn btn-outline-danger" style="padding: 6px 12px; white-space: nowrap;"><span class="fas fa-times mr-2"></span>Reset</button>
                    </div>
                </div>
            </div>
      ...
      <div class="card">
        ...
        <form action="report-tahunan.php" method="POST">
            ...
            <p>Note : Jika hanya ingin menampilkan 1 tahun saja, maka pilih tahun yang sama di kedua opsi dibawah</p>
                ...
                <div class="row">
                    <div class="col-md-6">  
                        <button type="submit" value="searchTahun" class="btn btn-outline-success mr-2" style="padding: 6px 12px; white-space: nowrap;"><span class="fas fa-search mr-2"></span>Search</button>
                        <button type="reset" class="btn btn-outline-danger" style="padding: 6px 12px; white-space: nowrap;"><span class="fas fa-times mr-2"></span>Reset</button>
                    </div>
                </div>
            </div>
