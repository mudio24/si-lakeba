...
<head>
    ...
    <title>Login | SI-LAKEBA SETDA KOTA CIREBON</title>
    <!-- icon diskominfo -->
    ...
    <div class="container">
        <div class="row content">
            <div class="col-md-6 mb-3">
                <img src="../assets/img/login-img.jpg" class="img-fluid" alt="login image">
            </div>
            <div class="col-md-6">
                <a class="btn logo" href="../index.php">SI-LAKEBA</a>
                <img src="css/setda-logo2.png" width="40" height="40">
                <p class="lead">Sistem Informasi Laporan Kerusakan Barang</p>
                ...
                <form action="" method="post">
                    ...
                    <hr> 
                    <p>Belum memiliki akun? Register di sini!</p>
                    <a href="sign-up.php" class="btn btn-signup">Sign up</a>
                </form>
                <br><center><p>Created by <a href='https://www.instagram.com/io.dii/' title='Instagram' target='_blank'>io.dii</a></p></center>
