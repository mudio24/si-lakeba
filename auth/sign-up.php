...
<head>
    ...
    <title>Sign Up | SI-LAKEBA SETDA KOTA CIREBON</title>
    <!-- icon diskominfo -->
    ...
    <div class="container">
        <div class="row content">
            <div class="col-md-6 mb-3">
                <img src="../assets/img/login-img.jpg" class="img-fluid mb-3" alt="login image">
            </div>
            <div class="col-md-6" style="margin-top: -30px;">
                <a class="btn logo" href="../index.php">SI-LAKEBA</a>
                <img src="css/setda-logo2.png" width="40" height="40">
                <p class="lead">Sistem Informasi SETDA Kota Cirebon</p>
